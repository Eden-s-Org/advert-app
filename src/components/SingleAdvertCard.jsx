import { ArrowLeft, MessageCircleCode, Star, X,  } from 'lucide-react'
...
const SingleAdvertCard = ({ advert, onDelete }) => {
    ...
    const whatsAppText = `Hi, I'm Emmanuel, I saw your advert "${advert?.title}" and want to buy. `;

    // Encode the text to make it URL-friendly
    const encodedText = encodeURIComponent(whatsAppText);

    // Create the WhatsApp link
    const whatAppLink = `https://wa.me/+233504659283?text=${encodedText}`;

    return (
        <>
            <Navbar />
            <div className="h-screen flex flex-col justify-center">
                <div class="bg-gray-200 min-h-[200px] grid grid-cols-1 md:grid-cols-2 md:mt-8 mx-auto ml-100 w-[60%] shadow-lg shadow-blue-950 rounded-2xl justify-center relative overflow-hidden">
                    <div className="flex flex-col justify-evenly rounded-s-2xl w-[80%] mx-auto">
                        ...
                        <img src={`https://res.cloudinary.com/dkvumu6xd/image/upload/${advert?.media}`} alt={advert?.title} className='w-[100%] h-80' />
                    </div>
                    <div class="flex flex-col justify-evenly">
                        ...
                        <div className="flex justify-end items-center mt-5 w-[90%] gap-5 relative">
                            ...
                            <div class=" flex ">
                                <Link to={'/dashboard/ads'} onClick={handleDelete} 
                            ...
                            <div>
                                {/* Your existing advert details go here */}
                                ...
                                <a
                                    ...
                                    className="flex items-center bg-green-500 text-white px-5 py-3 rounded-lg hover:bg-green-600 mb-5"
                                >
                                    <MessageCircleCode className="text-xl mr-2 h-7 w-7 hover:font-bold" />
                                    Chat
                                </a>
                            </div>
                        </div>
