...
const EditAdvert = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await apiUpdateAdvert(id, formData); // Make sure this function exists
            ...
            <div className='w-[82.2%] ml-60 flex gap-x-6 justify-center bg-gray-200 mt-15'>
                <section className='w-[75%] bg-gray-200 ml-5 flex flex-col justify-center gap-y-5'>
                    ...
                    <form onSubmit={handleSubmit} method="post" className='flex flex-col gap-y-5'>
                        ...
                        <div className='bg-white rounded-lg flex flex-col justify-center gap-y-3 py-3'>
                            ...
                            <div className=' w-[95%] mx-auto flex p-2 items-center gap-4'>
                                <div className='border border-gray-500 py-2 px-3 rounded-md'>
                                    ...
                                    <input type="file" name="media" id="advertImage" className='' accept='image/*' />
                                </div>
                        ...
                        <div className='bg-white rounded-lg flex flex-col justify-center gap-y-3 py-3'>
                            ...
                            <div className=' w-[95%] mx-auto flex flex-col gap-5'>
                                <div className='w-[100%] mx-auto flex flex-col gap-2 '>
                                    ...
                                    <input type="text" name="title" id="titleInput" title='Tile' placeholder='Enter title of your advert' value={formData.title} className='border border-gray-400 p-2 rounded-lg' onChange={handleChange} />
                                </div>
                                <div className='w-[100%] mx-auto flex flex-col gap-2'>
                                    <label htmlFor="categoryInput" className='font-semibold'>Category</label>
                                    <select name="category" id="categoryInput" placeholder='Select category' title='select category' value={formData.category} className='border border-gray-400 p-2 rounded-lg'>
                                ...
                                <div className='w-[100%] mx-auto flex flex-col gap-2'>
                                    ...
                                    <input type="number" name="price" id="priceInput" placeholder='How much is it going for?' value={formData.price} className='border border-gray-400 p-2 rounded-lg' title='Price' onChange={handleChange} />
                                </div>
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <textarea type="text" name="description" id="description" value={formData.description} className='w-[100%] bg-white px-2 py-1 pb-15 border-1 border-gray-400 rounded-lg' placeholder='Type here!' title='Description' onChange={handleChange} ></textarea>
                                </div>
                        ...
                        <div className='w-[61.7%] fixed bg-white rounded-md p-3 bottom-3 z-10 flex justify-end gap-x-3'>
                            ...
                            <button type="submit" className=" bg-[#424f74] hover:bg-blue-950 px-5 py-2 rounded-md text-white text-center font-bold cursor-pointer" >Update</button>
                        </div>
                    </form>
