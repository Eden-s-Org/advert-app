...
const Overview = () => {
  return (
    <>
      ...
      <div className='w-[82.4%] bg-gray-300 ml-auto h-screen'>
        <div className='w-[85%] mx-auto'>
          <div className='h-55 rounded-b-lg bg-[url(assets/images/cover-image.png)] bg-cover bg-gray-100 relative '>
            ...
            <div className='flex justify-center items-center gap-x-2 w-[16%] absolute right-5 bottom-5 cursor-pointer' title='Not available now'>
              <Camera/>
          ...
          <div className='flex justify-center items-center gap-x-2 my-10'>
            <Link to={'create-ad'} className='w-2/5 flex items-center justify-center gap-x-2 bg-[#EEAA77] p-2 rounded-md cursor-pointer hover:bg-[#b68865]'>
            ...
            <div className='w-1/5 flex items-center justify-center gap-x-2 bg-transparent border border-gray-500 p-2 rounded-md cursor-pointer hover:bg-gray-400' title='Not available now'>
            ...
            <div className='w-1/10 flex items-center justify-center gap-x-2 bg-transparent border border-gray-500 p-2 rounded-md cursor-pointer hover:bg-gray-400'>
              <h3 className='text-black/90 text-sm' title='Not available now'>More</h3>
              <ChevronDown className='size-5 text-black'/>
            </div>
            
          </div>
          <div className='bg-gray-100 rounded-lg mb-5 p-5'>
          <h1 className=' font-bold'>To-do list </h1>
          <p>Check unread messages, comments and other things that may require your attention.</p>
          </div>
          <div className='bg-gray-100 rounded-lg mb-5 p-5'>
          <h1 className=' font-bold'>Create your story </h1>
          <p>Creating reels truly exposses your product well to your customers</p>
          </div>
